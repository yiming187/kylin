export default {
  'en': {
    ...
    includeDim: 'Included Dimensions',
    includeDimTips: 'Add dimensions to aggregate group according to business scenarios, and effectively improve query performance by aggregate indexes',
    ...
    clearAllMandatoryTip: 'Are you sure you want to clear all mandatory dimensions of Aggregate-Group-{aggId}?',
    clearMandatoryTitle: 'Clear Mandatory Dimensions',
    ...
    sugession: 'Move the frequently used dimensions to the top of the list, in descending order of cardinality. Reasonable ordering can significantly improve the efficiency of aggregate queries.',
