...
export const GET_FAVORITE_RULES = 'GET_FAVORITE_RULES'
...
export const CHANGE_PROJECT_USER_DATA_PERMISSION = 'CHANGE_PROJECT_USER_DATA_PERMISSION'
...
export const CACHE_FROM_ROUTE = 'CACHE_FROM_ROUTE'
...
export const RECOMMENDATION_COUNT_REFRESH = 'RECOMMENDATION_COUNT_REFRESH'
export const DELETE_RECOMMENDATIONS = 'DELETE_RECOMMENDATIONS'
export const ACCESS_RECOMMENDATIONS = 'ACCESS_RECOMMENDATIONS'
export const GET_RECOMMEND_DETAILS = 'GET_RECOMMEND_DETAILS'
export const VALIDATE_RECOMMEND = 'VALIDATE_RECOMMEND'
...
export const SAVE_OPTIMIZE_LAYOUT_DATA = 'SAVE_OPTIMIZE_LAYOUT_DATA'
export const GET_INDEX_DETAIL = 'GET_INDEX_DETAIL'
export const DOWNLOAD_OPTIMIZE_LAYOUT_TEMPLATE = 'DOWNLOAD_OPTIMIZE_LAYOUT_TEMPLATE'
// table index
...
export const GET_CURRENT_USER_DATA_PERMISSION = 'GET_CURRENT_USER_DATA_PERMISSION'
