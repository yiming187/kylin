...
public class SegmentControllerV2 extends NBasicController {
    ...
    @GetMapping(value = "")
    @ResponseBody
    public EnvelopeResponse<Map<String, Object>> getCubes(@RequestParam(value = "projectName") String project,
        ...
        Map<String, Object> modelResponse = getDataResponse("cubes", result, offset, limit);
