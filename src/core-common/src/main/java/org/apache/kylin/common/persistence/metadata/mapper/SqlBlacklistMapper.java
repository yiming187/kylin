...
import static org.apache.kylin.common.persistence.metadata.mapper.SqlBlacklistDynamicSqlSupport.sqlTable;
...
public interface SqlBlacklistMapper extends BasicMapper<SqlBlacklistRawResource> {
    @Override
    ...
    @ResultMap("SqlBlacklistResult")
    Optional<SqlBlacklistRawResource> selectOne(SelectStatementProvider selectStatement);

    @Override
    @SelectProvider(type = SqlProviderAdapter.class, method = "select")
    @Results(id = "SqlBlacklistResult", value = {
    ...
    List<SqlBlacklistRawResource> selectMany(SelectStatementProvider selectStatement);

    @Override
    @SelectProvider(type = SqlWithRecordLockProviderAdapter.class, method = "select")
    @ResultMap("SqlBlacklistResult")
    List<SqlBlacklistRawResource> selectManyWithRecordLock(SelectStatementProvider selectStatement);
}
