...
public class TransactionManagerInstance {
    public static final TransactionLockManager INSTANCE;

    static {
        INSTANCE = (TransactionLockManager) ClassUtil
                .newInstance(KylinConfig.getInstanceFromEnv().getTransactionLockManager());
    }
