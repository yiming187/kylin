...
public class IntentionShareLock implements IntentionLock {
    ...
    public Set<Long> getReadLockDependencyThreads(Long threadId) {
        if (shareLock instanceof IntentionReadWriteLock.InnerReadLock) {
            return ((IntentionReadWriteLock.InnerReadLock) shareLock).getLockDependencyThreads(threadId);
        }
