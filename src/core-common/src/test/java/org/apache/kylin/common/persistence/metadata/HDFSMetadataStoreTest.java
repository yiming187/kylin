...
class HDFSMetadataStoreTest {
    ...
    void testStartKEWithBackupDir() throws IOException {
        ...
        HDFSMetadataStore hdfsMetadataStore = new HDFSMetadataStore(newKylinConfig);
        ...
        HDFSMetadataStore hdfsMetadataStore2 = new HDFSMetadataStore(newKylinConfig);
        ...
        HDFSMetadataStore hdfsMetadataStore3 = new HDFSMetadataStore(newKylinConfig);
        ...
        HDFSMetadataStore hdfsMetadataStore4 = new HDFSMetadataStore(newKylinConfig);
