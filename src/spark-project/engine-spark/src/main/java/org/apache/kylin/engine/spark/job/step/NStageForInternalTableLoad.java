...
public class NStageForInternalTableLoad extends StageBase {

    public NStageForInternalTableLoad() {
    }

    public NStageForInternalTableLoad(Object notSetId) {
        super(notSetId);
    }

    public NStageForInternalTableLoad(String name) {
        super(name);
    }
